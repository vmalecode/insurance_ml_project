...
att_p = pd.read_csv('attending_phy_count.csv', header=0, index_col=0, squeeze = True).to_dict()
att_op = pd.read_csv('operating_phy_count.csv', header=0, index_col=0, squeeze = True).to_dict()
att_ot = pd.read_csv('other_phy_count.csv', header=0, index_col=0, squeeze = True).to_dict()
prv_csv = pd.read_csv('provider_phy_count.csv', header=0, index_col=0, squeeze = True).to_dict()
